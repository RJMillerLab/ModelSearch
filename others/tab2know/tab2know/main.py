...
def run(
    ...
    modeldir: 'Model directory' = 'models/tabletypes-lr-pipeline.pkl',
    ...
    if annotationdir:
        ...
        import flexible_collect
        total = flexible_collect.get_csv_count_flexible(basedir)
        for meta in tqdm.tqdm(flexible_collect.get_all_metadata_flexible(
